...
public class RiceParser extends Parser {
	...
	public static final int
		...
		STRING=18;
	public static final int
		RULE_program = 0, RULE_riceBlock = 1, RULE_cookBlock = 2, RULE_statement = 3, 
	...
	public static class RiceBlockContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_riceBlock; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).enterRiceBlock(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).exitRiceBlock(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RiceVisitor ) return ((RiceVisitor<? extends T>)visitor).visitRiceBlock(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class CookBlockContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_cookBlock; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).enterCookBlock(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).exitCookBlock(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RiceVisitor ) return ((RiceVisitor<? extends T>)visitor).visitCookBlock(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final CookBlockContext cookBlock() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__4) | (1L << T__6) | (1L << T__8) | (1L << ID))) != 0)) {
				{
				{
				setState(40);
				statement();
	...
	public static class DeclarationStmtContext extends ParserRuleContext {
		...
		public TerminalNode INT() { return getToken(RiceParser.INT, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).enterDeclarationStmt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).exitDeclarationStmt(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RiceVisitor ) return ((RiceVisitor<? extends T>)visitor).visitDeclarationStmt(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DeclarationStmtTailContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_declarationStmtTail; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).enterDeclarationStmtTail(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).exitDeclarationStmtTail(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RiceVisitor ) return ((RiceVisitor<? extends T>)visitor).visitDeclarationStmtTail(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AssignmentStmtContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).enterAssignmentStmt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).exitAssignmentStmt(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RiceVisitor ) return ((RiceVisitor<? extends T>)visitor).visitAssignmentStmt(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class PrintStmtContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).enterPrintStmt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).exitPrintStmt(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RiceVisitor ) return ((RiceVisitor<? extends T>)visitor).visitPrintStmt(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExprContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).enterExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).exitExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RiceVisitor ) return ((RiceVisitor<? extends T>)visitor).visitExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AddExprContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).enterAddExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).exitAddExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RiceVisitor ) return ((RiceVisitor<? extends T>)visitor).visitAddExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MulExprContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).enterMulExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).exitMulExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RiceVisitor ) return ((RiceVisitor<? extends T>)visitor).visitMulExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FactorContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).enterFactor(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).exitFactor(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RiceVisitor ) return ((RiceVisitor<? extends T>)visitor).visitFactor(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AddOpContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).enterAddOp(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).exitAddOp(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RiceVisitor ) return ((RiceVisitor<? extends T>)visitor).visitAddOp(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MulOpContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).enterMulOp(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).exitMulOp(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RiceVisitor ) return ((RiceVisitor<? extends T>)visitor).visitMulOp(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ServeStmtContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).enterServeStmt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).exitServeStmt(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RiceVisitor ) return ((RiceVisitor<? extends T>)visitor).visitServeStmt(this);
			else return visitor.visitChildren(this);
		}
	}
