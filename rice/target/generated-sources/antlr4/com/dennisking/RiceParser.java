...
public class RiceParser extends Parser {
	...
	public static class StartContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).enterStart(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RiceListener ) ((RiceListener)listener).exitStart(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RiceVisitor ) return ((RiceVisitor<? extends T>)visitor).visitStart(this);
