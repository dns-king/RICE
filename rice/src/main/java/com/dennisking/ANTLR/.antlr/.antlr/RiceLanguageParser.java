...
public class RiceLanguageParser extends Parser {
	...
	public RiceLanguageParser(TokenStream input) {
		super(input);
	...
	public static class ExpressionContext extends ParserRuleContext {
		...
		public List<TerminalNode> ADDITION() { return getTokens(RiceLanguageParser.ADDITION); }
		public TerminalNode ADDITION(int i) {
			return getToken(RiceLanguageParser.ADDITION, i);
		}
		public List<TerminalNode> SUBTRACT() { return getTokens(RiceLanguageParser.SUBTRACT); }
		public TerminalNode SUBTRACT(int i) {
			return getToken(RiceLanguageParser.SUBTRACT, i);
		}
	...
	public final ExpressionContext expression() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while (_la==ADDITION || _la==SUBTRACT) {
				{
				{
				setState(5);
				_la = _input.LA(1);
	...
	public static class TermContext extends ParserRuleContext {
		public List<TerminalNode> NUMBER() { return getTokens(RiceLanguageParser.NUMBER); }
		public TerminalNode NUMBER(int i) {
			return getToken(RiceLanguageParser.NUMBER, i);
		}
